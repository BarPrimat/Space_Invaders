...
namespace Screens.MainMenuScreens
{
    public class ScreenSettingsMenu : GameScreen
    {
        ...
        private void initMenuItems()
        {
            ...
            m_ItemListManager.AddNewItem(new ToggleItem("Mouse Visibility: ", this, ToggleItem.eToggleItemType.VisibleInvisibleItem, SettingsCollection.IsMouseVisible));
            m_ItemListManager.LastInsertItem().ItemIsClicked += mouseVisibility_ItemIsClicked;
        ...
        private void mouseVisibility_ItemIsClicked(object i_Sender, EventArgs i_EventArgs)
        {
