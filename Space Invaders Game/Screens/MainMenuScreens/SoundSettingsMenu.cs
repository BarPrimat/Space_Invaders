...
namespace Screens.MainMenuScreens
{
    public class SoundSettingsMenu : GameScreen
    {
        ...
        private ToggleItem m_ToggleSoundItem;
        ...
        {
            m_ToggleSoundItem = new ToggleItem("Toggle Sound: ", this, ToggleItem.eToggleItemType.OnOffItem, r_SoundManager.AreAllSoundsMuted);
            m_ItemListManager.AddNewItem(m_ToggleSoundItem);
        ...
        public override void Update(GameTime i_GameTime)
        {
            ...
            m_ToggleSoundItem.InitOption(r_SoundManager.AreAllSoundsMuted);
        }
